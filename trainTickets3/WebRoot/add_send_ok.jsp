...
//提交客户意见或建议
	...
	if(a_id!=null && a_id!="")
	{
	...
	
		{
			...
			String sql="insert into Train values('"+num+"','"+stime+"','"+etime+"','"+sstation+"','"+estation+"','"+customcount+"','"+leftcount+"','"+price+"')";
...
<!--DWLayoutTable-->
	...
	<tr>
		<td height="57" align="center"><span class="STYLE10">添加成功<span class="STYLE3">！</span></span></span></td>
			...
			{
				out.println( "<HTML><HEAD><META http-equiv='refresh' content='3; URL=add.jsp' target=Main></HEAD><BODY bgcolor='#FFFFFF'><center><font size=4pt color='red'>" + "添加失败，列车号重复了..." + "</font></center></body></html>");
			}
	...
	{
		out.println( "<HTML><HEAD><META http-equiv='refresh' content='2;URL=add.jsp?a_id=" + a_id + " ' target=Main></HEAD><BODY bgcolor='#FFFFFF'></body></html>");
			%>
<br /><br /><br /><br /><br /><br /><br /><br />
<center>
 <table width="300" border="1" bordercolor="#99CCFF" style="border-collapse:collapse" cellpadding="0" cellspacing="0">
